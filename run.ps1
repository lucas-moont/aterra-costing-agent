...
Write-Host "`n=== 1/3  Extraction (LangGraph + local Claude) ===" -ForegroundColor Cyan
& "$root/extraction/.venv/Scripts/python.exe" "$root/extraction/run_extraction.py" --cached
